package com.lambdaschool.sprint.gdp.gdp.handler;

import com.lambdaschool.sprint.gdp.gdp.Exception.ResourceNotFoundException;
import com.lambdaschool.sprint.gdp.gdp.Models.ErrorDetail;
...
public class RestExceptionHandlerClass {
    ...
    public class RestExceptionHandler extends ResponseEntityExceptionHandler {
        ...
        public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException rnfe, HttpServletRequest request) {
            ...
            return new ResponseEntity(errorDetail, (MultiValueMap<String, String>) null, HttpStatus.NOT_FOUND);
        }
        ...
        protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
            ...
            return new ResponseEntity(errorDetail, (MultiValueMap)null, HttpStatus.NOT_FOUND);
        }
